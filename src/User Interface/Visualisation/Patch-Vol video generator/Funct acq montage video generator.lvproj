...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="All parameters cluster reference.ctl" Type="VI" URL="../../Functional Imaging Viewer/SubVIs/Experiment header interface/Typedefs/All parameters cluster reference.ctl"/>
			...
			<Item Name="Header parameters cluster-Live imaging.ctl" Type="VI" URL="../../Functional Imaging Viewer/SubVIs/Experiment header interface/Typedefs/Header parameters cluster-Live imaging.ctl"/>
			<Item Name="Header parameters cluster-Zstack.ctl" Type="VI" URL="../../Functional Imaging Viewer/SubVIs/Experiment header interface/Typedefs/Header parameters cluster-Zstack.ctl"/>
			<Item Name="Header params-Funct acq w rectangles.ctl" Type="VI" URL="../../Functional Imaging Viewer/SubVIs/Experiment header interface/Typedefs/Header params-Funct acq w rectangles.ctl"/>
